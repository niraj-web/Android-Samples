...
import com.example.timesheetassignment.Adapter.AdditionAdapter;
import com.example.timesheetassignment.Adapter.ClientHourAdapter;
import com.example.timesheetassignment.Adapter.EmployeeNameAdapter;
import com.example.timesheetassignment.Adapter.ProjectNameAdapter;
import com.example.timesheetassignment.Adapter.TSMinAdapter;
import com.example.timesheetassignment.Adapter.TsHourAdapter;
import com.example.timesheetassignment.Adapter.WorkTypeAdapter;
import com.example.timesheetassignment.Model.ProjectAssModel;
import com.example.timesheetassignment.R;
import com.example.timesheetassignment.utils.ApiRequestHelper;
import com.example.timesheetassignment.utils.CommonInterface;
import com.example.timesheetassignment.utils.Utils;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvProjectName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SearchView searchView = (SearchView) dialog.findViewById(R.id.ProjectsearchView);
                ...
                searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                    ...
                    //    projectname.getFilter().filter(s);
                        return false;
                    }
                });
                dialog.show();
        ...
        tvEmployeeSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                SearchView searchView = (SearchView) dialog.findViewById(R.id.EmployeesearchView);
