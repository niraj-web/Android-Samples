...
public class Utils {
    ...
    //terhab/hotelbookingwp/wp-json/manazil/v1/
    public static final String OTP_DELIMITER = ":";
    public static final String DATE_FORMAT_DMY = "dd-MM-yyyy";
    public static final String BASE_URL = "http://stage.doodleworldwide.net/";
    public static final String BASE_URL1 = "http://dev.maxdigi.co/";
