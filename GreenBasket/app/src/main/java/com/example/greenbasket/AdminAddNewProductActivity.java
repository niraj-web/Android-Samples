...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddNewProductButton = (Button) findViewById(R.id.add_new_prodct);
    ...
    private void ValidateProductData()
    {
        ...
        {
            Toast.makeText(this,"Please writeproduct name...",Toast.LENGTH_SHORT).show();
        }
        else
            {
    ...
    private void StoreProductInformation()
    {
        ...
        StorageReference filePath = ProductImagesRef.child(ImageUri.getLastPathSegment() + randomNumber + ".jpg");
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        ProductsRef.child("Categories").child(CategoryName).child(String.valueOf(randomNumber)).updateChildren(productMap)
