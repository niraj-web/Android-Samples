...
import com.example.offersassignment.Adapter.PageAdapter;
...
//                    Utils.showLongToast(mContext,projectAssModel.getMsg());
                    if (offerDetailsModel != null) {
                        if (offerDetailsModel.getStatus()  && offerDetailsModel.getIsUserAuthTokenValid() != null) {
                            ...
                            final PageAdapter adapter = new PageAdapter(getSupportFragmentManager(),3,offerDetailsModel,OfferDetailActivity.this);
