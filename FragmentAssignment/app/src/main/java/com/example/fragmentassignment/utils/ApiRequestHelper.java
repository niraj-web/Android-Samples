...
{
    static Gson gson;
    private static com.example.fragmentassignment.utils.ApiRequestHelper instance;
    private App app;
    private Api appService;

    public static synchronized com.example.fragmentassignment.utils.ApiRequestHelper init(App app) {
        if (null == instance) {
            instance = new com.example.fragmentassignment.utils.ApiRequestHelper();
...
// add logging as last interceptor
   ...
   /* public void login(Map<String, String> params, final OnRequestComplete onRequestComplete) {
    ...
    public void updateProjectAssign(Map<String, String> params, final OnRequestComplete onRequestComplete) {
        Call<OffersModel> call = appService.Data(params,"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJUSEVfSVNTVUVSIiwiYXVkIjoiVEhFX0FVRElFTkNFIiwiaWF0IjoxNjE5Njk2MjcxLCJuYmYiOjE2MTk2OTYyODEsImV4cCI6MTYxOTc4MjY3MSwiZGF0YSI6eyJpZCI6MywiZGlzcGxheU5hbWUiOiJIYXJpIiwiZW1haWwiOiJuYXJoYXJpQG1heGRpZ2kuY29tIn19.xYeH0xL0qrGME1Rzuk0euLKu_SI4QtaCUnP5Aro4FEA");
