package com.example.ratingassignment.utils;
...
public class ApiRequestHelper {
    static Gson gson;
    private static com.example.ratingassignment.utils.ApiRequestHelper instance;
    private App app;
    private Api appService;

    public static synchronized com.example.ratingassignment.utils.ApiRequestHelper init(App app) {
        if (null == instance) {
            instance = new com.example.ratingassignment.utils.ApiRequestHelper();
...
// add logging as last interceptor
   ...
   /* public void login(Map<String, String> params, final OnRequestComplete onRequestComplete) {
    ...
    public void updateProjectAssign(Map<String, String> params, final OnRequestComplete onRequestComplete) {
        Call<ProjectAssModel> call = appService.Data(params,"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJUSEVfSVNTVUVSIiwiYXVkIjoiVEhFX0FVRElFTkNFIiwiaWF0IjoxNjE4MjE1MDc2LCJuYmYiOjE2MTgyMTUwODYsImV4cCI6MTYxODMwMTQ3NiwiZGF0YSI6eyJpZCI6MywiZGlzcGxheU5hbWUiOiJIYXJpIiwiZW1haWwiOiJuYXJoYXJpQG1heGRpZ2kuY29tIn19.RU2-giNkWOAvlSum9nDg3P9y6OQVE-YgGfFU9bFMgfE");
        call.enqueue (new Callback<ProjectAssModel>() {
            @Override
            public void onResponse(Call<ProjectAssModel> call, Response<ProjectAssModel> response) {
                if (response.isSuccessful ()) {
