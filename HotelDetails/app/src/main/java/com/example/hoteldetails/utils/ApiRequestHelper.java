package com.example.hoteldetails.utils;
...
{
    static Gson gson;
    private static com.example.hoteldetails.utils.ApiRequestHelper instance;
    private App app;
    private Api appService;

    public static synchronized com.example.hoteldetails.utils.ApiRequestHelper init(App app) {
        if (null == instance) {
            instance = new com.example.hoteldetails.utils.ApiRequestHelper();
