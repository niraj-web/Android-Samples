...
public class ApiRequestHelper {
    static Gson gson;
    private static com.example.hospitalbookingassignmet.utils.ApiRequestHelper instance;
    private App app;
    private Api appService;

    public static synchronized com.example.hospitalbookingassignmet.utils.ApiRequestHelper init(App app) {
        if (null == instance) {
            instance = new com.example.hospitalbookingassignmet.utils.ApiRequestHelper();
...
// add logging as last interceptor
   ...
   /* public void login(Map<String, String> params, final OnRequestComplete onRequestComplete) {
    ...
    public void updateProjectAssign(Map<String, String> params, final OnRequestComplete onRequestComplete) {
        Call<ModelClass> call = appService.Data(params,"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..x1n1zYlonRr9fpfS8pCAAzhA_k4QIjTH4ELJufAJWRY");
