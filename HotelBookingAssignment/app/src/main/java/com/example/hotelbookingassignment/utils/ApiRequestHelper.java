...
{
    static Gson gson;
    private static com.example.hotelbookingassignment.utils.ApiRequestHelper instance;
    private App app;
    private Api appService;

    public static synchronized com.example.hotelbookingassignment.utils.ApiRequestHelper init(App app) {
        if (null == instance) {
            instance = new com.example.hotelbookingassignment.utils.ApiRequestHelper();
...
// add logging as last interceptor
   ...
   /* public void login(Map<String, String> params, final OnRequestComplete onRequestComplete) {
    ...
    public void updateProjectAssign(Map<String, String> params, final OnRequestComplete onRequestComplete) {
        Call<ProjectAssModel> call = appService.Data(params,"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..8xYrhpL2Pcv4TJlmpfog231elLsYofyl3UBnoUg2_qU");
        call.enqueue (new Callback<ProjectAssModel>() {
            @Override
            public void onResponse(Call<ProjectAssModel> call, Response<ProjectAssModel> response) {
                if (response.isSuccessful ()) {
